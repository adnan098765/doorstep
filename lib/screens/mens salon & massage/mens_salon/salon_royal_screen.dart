...
import 'controller/men_salon_royal_controller.dart';

class SalonRoyalScreen extends StatefulWidget {
  const SalonRoyalScreen({super.key});

  @override
  State<SalonRoyalScreen> createState() => _SalonRoyalScreenState();
}

class _SalonRoyalScreenState extends State<SalonRoyalScreen> {
  ...
  final MenRoyalPackagesController menRoyalPackagesController = Get.put(MenRoyalPackagesController());
  final MenRoyalGroomingController menRoyalGroomingController = Get.put(MenRoyalGroomingController());
  final MenRoyalGlowController menRoyalGlowController = Get.put(MenRoyalGlowController());
  final MenRoyalCutController menRoyalCutController = Get.put(MenRoyalCutController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    ...
                                    onIncrement: () => menRoyalPackagesController.increment(),
                                    onDecrement: () => menRoyalPackagesController.decrement(),
                                    count: menRoyalPackagesController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menRoyalGroomingController.increment(),
                                    onDecrement: () => menRoyalGroomingController.decrement(),
                                    count: menRoyalGroomingController.count.value.toString(),
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menRoyalGlowController.increment(),
                                    onDecrement: () => menRoyalGlowController.decrement(),
                                    count: menRoyalGlowController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menRoyalCutController.increment(),
                                    onDecrement: () => menRoyalCutController.decrement(),
                                    count: menRoyalCutController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
      ...
      bottomNavigationBar: Obx(() {
        bool shouldShowBottomBar = menRoyalCutController.count.value > 0 ||
            menRoyalGlowController.count.value > 0 ||
            menRoyalGroomingController.count.value > 0 ||
            menRoyalPackagesController.count.value > 0;
