...
class MenFloatingButtonController extends GetxController {
...
class MensSalonFloatingActionButton extends StatelessWidget {
  final Function(int index) onTap;
  final List<GlobalKey> keys;

  MensSalonFloatingActionButton({super.key, required this.onTap, required this.keys});

  final MenFloatingButtonController controller = Get.put(MenFloatingButtonController());
