...
import 'controller/men_prime_massage_controller.dart';

class PrimeMassageScreen extends StatefulWidget {
  const PrimeMassageScreen({super.key});

  @override
  State<PrimeMassageScreen> createState() => _PrimeMassageScreenState();
}

class _PrimeMassageScreenState extends State<PrimeMassageScreen> {
  ...
  final MenPrimeMassagePackagesController menPrimeMassagePackagesController = Get.put(MenPrimeMassagePackagesController());
  final MenPrimeMassageGroomingController menPrimeMassageGroomingController = Get.put(MenPrimeMassageGroomingController());
  final MenPrimeMassageGlowController menPrimeMassageGlowController = Get.put(MenPrimeMassageGlowController());
  final MenPrimeMassageCutController menPrimeMassageCutController = Get.put(MenPrimeMassageCutController());
    ...
    return Scaffold(
      ...
      body: Stack(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appText("Massage for men", fontSize: 22.px, fontWeight: FontWeight.bold),
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    ...
                                    onIncrement: () => menPrimeMassagePackagesController.increment(),
                                    onDecrement: () => menPrimeMassagePackagesController.decrement(),
                                    count: menPrimeMassagePackagesController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menPrimeMassageGroomingController.increment(),
                                    onDecrement: () => menPrimeMassageGroomingController.decrement(),
                                    count: menPrimeMassageGroomingController.count.value.toString(),
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menPrimeMassageGlowController.increment(),
                                    onDecrement: () => menPrimeMassageGlowController.decrement(),
                                    count: menPrimeMassageGlowController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menPrimeMassageCutController.increment(),
                                    onDecrement: () => menPrimeMassageCutController.decrement(),
                                    count: menPrimeMassageCutController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
       ...
       bottomNavigationBar: Obx(() {
        bool shouldShowBottomBar = menPrimeMassageCutController.count.value > 0 ||
            menPrimeMassageGlowController.count.value > 0 ||
            menPrimeMassageGroomingController.count.value > 0 ||
            menPrimeMassageCutController.count.value > 0;
