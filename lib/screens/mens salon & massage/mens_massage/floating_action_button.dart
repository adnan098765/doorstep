...
class MenMassageFloatingButtonController extends GetxController {
...
class MensMassageFloatingActionButton extends StatelessWidget {
  final Function(int index) onTap;
  final List<GlobalKey> keys;

  MensMassageFloatingActionButton({super.key, required this.onTap, required this.keys});

  final MenMassageFloatingButtonController controller = Get.put(MenMassageFloatingButtonController());
