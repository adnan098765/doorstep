...
import 'package:doorstep_company_app/screens/mens%20salon%20&%20massage/components/mens_salon_view_detail_sheet.dart';
...
class MensMassageDetailScreen extends StatefulWidget {
  const MensMassageDetailScreen({super.key});

  @override
  State<MensMassageDetailScreen> createState() => _MensMassageDetailScreenState();
}

class _MensMassageDetailScreenState extends State<MensMassageDetailScreen> {
  ...
  final MenMassagePackagesController menMassagePackagesController = Get.put(MenMassagePackagesController());
  final MenMassageGroomingController menMassageGroomingController = Get.put(MenMassageGroomingController());
  final MenMassageGlowController menMassageGlowController = Get.put(MenMassageGlowController());
  final MenMassageCutController menMassageCutController = Get.put(MenMassageCutController());
...
// To Get Position
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: MensMassageFloatingActionButton(
        keys: keys,
        onTap: (index) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appText("Salon Royal", fontSize: 22.px, fontWeight: FontWeight.bold),
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    ...
                                    onIncrement: () => menMassagePackagesController.increment(),
                                    onDecrement: () => menMassagePackagesController.decrement(),
                                    count: menMassagePackagesController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menMassageGlowController.increment(),
                                    onDecrement: () => menMassageGlowController.decrement(),
                                    count: menMassageGlowController.count.value.toString(),
                                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menMassageCutController.increment(),
                                    onDecrement: () => menMassageCutController.decrement(),
                                    count: menMassageCutController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                AddItemButton(
                                  ...
                                  addButton: AddButton(
                                    color: AppColors.whiteTheme,
                                    onIncrement: () => menMassageGroomingController.increment(),
                                    onDecrement: () => menMassageGroomingController.decrement(),
                                    count: menMassageGroomingController.count.value.toString(),
                                  ),
                                )
                              ],
                            ),
      ...
      bottomNavigationBar: Obx(() {
        bool shouldShowBottomBar = menMassagePackagesController.count.value > 0 ||
            ...
            menMassageCutController.count.value > 0;
