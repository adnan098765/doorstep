...
class SpaFloatingButtonController extends GetxController {
...
class SpaFloatingActionButton extends StatelessWidget {
  final Function(int index) onTap;
  final List<GlobalKey> keys;

  SpaFloatingActionButton({super.key, required this.onTap, required this.keys});

  final SpaFloatingButtonController controller = Get.put(SpaFloatingButtonController());
