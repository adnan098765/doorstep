...
class WomenHairFloatingButtonController extends GetxController {
...
class WomenHairFloatingActionButton extends StatelessWidget {
  final Function(int index) onTap;
  final List<GlobalKey> keys;

  WomenHairFloatingActionButton({super.key, required this.onTap, required this.keys});

  final WomenHairFloatingButtonController controller = Get.put(WomenHairFloatingButtonController());
