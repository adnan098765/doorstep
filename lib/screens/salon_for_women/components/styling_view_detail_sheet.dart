...
class StyleBottomSheet extends StatefulWidget {
  const StyleBottomSheet({
    super.key,
  });

  @override
  State<StyleBottomSheet> createState() => _StyleBottomSheetState();
}

class _StyleBottomSheetState extends State<StyleBottomSheet> {
  List<String> images = [
