...
class SpaViewDetailSheet extends StatefulWidget {
  const SpaViewDetailSheet({super.key});

  @override
  State<SpaViewDetailSheet> createState() => _SpaViewDetailSheetState();
}

class _SpaViewDetailSheetState extends State<SpaViewDetailSheet> {
  List<String> images = [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        appText('Rs. 0', fontWeight: FontWeight.bold, fontSize: 16.px),
                        const Spacer(),
                        roundButton(
                            onTap: () {
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      appText('60 mins', fontSize: 18, fontWeight: FontWeight.bold),
                                      Row(children: [
                      ...
                      div(),
                      SizedBox(height: 10.px),
                      appText('Why UC Ayurveda', fontSize: 24, fontWeight: FontWeight.bold),
                ...
                CustomContainer(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          appText('Overview', fontSize: 24, fontWeight: FontWeight.bold),
                              ...
                              return Column(
                                children: [
                                  ...
                                  appText('Relaxesmuscles &\n improves circulation',
                                      fontSize: 16, color: AppColors.hintGrey)
                                ],
                              );
                            },
                          )
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomContainer(
                          ...
                          child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  appText('Best for', fontSize: 18, fontWeight: FontWeight.bold),
                      ...
                      SizedBox(height: 20.px),
                      appText('Spa-like ambience at home', fontSize: 22, fontWeight: FontWeight.bold),
                      SizedBox(height: 12.px),
                      CustomContainer(
                          height: 200.px,
                          width: double.maxFinite,
                      ...
                      Divider(thickness: 8, color: AppColors.grey300),
                      SizedBox(height: 12.px),
                      appText('We bring the spa for you', fontSize: 24, fontWeight: FontWeight.bold),
                      SizedBox(height: 12.px),
                      GridView.builder(
                        itemCount: 4,
                        shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            ...
                            children: [
                              ...
                              appText('6ft x 2.5ft with a\ncapacity of 280kg', fontSize: 16, color: AppColors.hintGrey)
                            ],
                          );
                        },
                      ),
                      ...
                      Divider(thickness: 8, color: AppColors.grey300),
                      SizedBox(height: 20.px),
                      appText('Oil used', fontSize: 24, fontWeight: FontWeight.bold),
                      SizedBox(height: 20.px),
                      ListView.builder(
                          itemCount: 2,
                          shrinkWrap: true,
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    appText('Hair massage oil', fontSize: 22, fontWeight: FontWeight.bold),
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Row(spacing: 10.px, children: [
                                        appText('Know more', fontSize: 16, fontWeight: FontWeight.bold),
                      ...
                      Divider(thickness: 8, color: AppColors.grey300),
                      SizedBox(height: 20.px),
                      appText("Massage pre-requisites", fontSize: 22, fontWeight: FontWeight.bold),
                      ...
                      div(),
                      SizedBox(height: 20.px),
                      appText('UC therapist', fontSize: 24, fontWeight: FontWeight.bold),
                      SizedBox(height: 10.px),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              appText('Skilled therapist', fontSize: 20, fontWeight: FontWeight.bold),
                              ...
                              SizedBox(height: 20.px),
                              appText('Personalized therapy', fontSize: 20, fontWeight: FontWeight.bold),
                              SizedBox(height: 6.px),
                      ...
                      div(),
                      SizedBox(height: 20.px),
                      appText('Aftercare tips', fontSize: 24, fontWeight: FontWeight.bold),
                      SizedBox(height: 12.px),
                      ...
                      div(),
                      SizedBox(height: 20.px),
                      appText('Disclaimer', fontSize: 18, fontWeight: FontWeight.bold),
                      SizedBox(height: 20.px),
                      appText(
...
// Avoid row widget
//  Suggestion row widget
Widget avoidRow(final String text) {
  return Row(
    children: [
...
// Row for Best for section
Widget bestRow({required String text}) {
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        appText(text, color: AppColors.hintGrey, fontSize: 16),
      ],
    ),
  );
}
