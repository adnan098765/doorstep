...
class HomeFloatingButtonController extends GetxController {
...
class HomeCleaningFloatingActionButton extends StatelessWidget {
  final Function(int index) onTap;
  final List<GlobalKey> keys;

  HomeCleaningFloatingActionButton({super.key, required this.onTap, required this.keys});

  final HomeFloatingButtonController controller = Get.put(HomeFloatingButtonController());
